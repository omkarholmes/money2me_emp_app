...
class LoanCloser extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _LoanCloserState();
}

class _LoanCloserState extends ConsumerState<LoanCloser> {
  ...
  Widget build(context) {
    return Scaffold(
        body: ref.watch(loanCloserProvider(widget.loanDetailRequest)).when(
            data: (data) {
      ...
      return isPaymentLoading
          ...
          : ListView(
              shrinkWrap: true,
              padding:
                  const EdgeInsets.symmetric(horizontal: 16, vertical: 32).r,
              children: [
                Container(
